        ...
        <div className="p-2 h-full border-2 border-dashed border-amber-200 rounded-2xl grid grid-rows-[1fr_60px_1fr_38px] gap-2">
          <div className="flex flex-col justify-center items-center relative overflow-hidden">
            ...
            <img
              src={star}
              alt=""
              className="size-7 absolute left-45 bottom-40 rotate-15"
            />
            <img
              src={star}
              alt=""
              className="size-4 absolute left-41 bottom-41 rotate-15"
            />
            <img
              src={star}
              alt=""
              className="size-3 absolute right-48 bottom-25"
            />
          </div>
          <div>
